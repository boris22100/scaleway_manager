...
Protection : Détection automatique du flag "protected" sur Scaleway (la corbeille disparaît pour éviter les erreurs).
...
Import Bulk : Synchronisation de zone entière par copier-coller de texte brut.
...
Bash
git clone https://github.com/boris22100/scaleway_manager.git
cd scaleway_manager
...
.gitignore (Crucial pour la sécurité)
...
Touche Entrée : Le formulaire est validé automatiquement en appuyant sur Entrée.

F5 / Rafraîchissement : Grâce à la gestion des jetons de session, vous restez connecté même après un rafraîchissement de la page.

Étape 3 : Ajout de vos clés API
Allez dans l'onglet ⚙️ Comptes :

Ajoutez un profil (ex: "BoWiz Prod").
...
Cliquez sur l'un de vos domaines affichés pour charger les records existants.
